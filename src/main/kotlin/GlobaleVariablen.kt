...
val specialNumber: List<Int> = listOf(0)   // Es ist absichtlich eine Liste mit der 0, da die Parameter Listen übergeben und die Auskunkt dann erteilen, ob gerade/ungerade oder rot/schwarz usw. Besondere Zahl (0)
